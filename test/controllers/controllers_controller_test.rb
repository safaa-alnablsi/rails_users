...
class ControllersControllerTest < ActionController::TestCase
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post :create, controller: { Posts: @controller.Posts, destroy: @controller.destroy, edit: @controller.edit, new: @controller.new, show: @controller.show }
    end
  ...
  test "should update controller" do
    patch :update, id: @controller, controller: { Posts: @controller.Posts, destroy: @controller.destroy, edit: @controller.edit, new: @controller.new, show: @controller.show }
    assert_redirected_to controller_path(assigns(:controller))
  end
